...
<div id="wrapper" class="container-fluid">	
  ...
  <?php $id = ( cyberchimps_get_option( 'header_image' ) ) ? 'header_container_bg' : 'header_container'; ?>
  <div id="<?php echo $id; ?>" style="background-image: url( <?php echo cyberchimps_get_option( 'header_image' ); ?> );">  
