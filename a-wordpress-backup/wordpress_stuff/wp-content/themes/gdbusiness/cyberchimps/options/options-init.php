    ...
    <?php do_action( 'cyberchimps_options_before_container' ); ?>
		<div class="container-fluid cc-options">
			...
			<div class="row-fluid cc-header">
				<div class="span4">
        	<div class="cc-title">
            <a href="http://cyberchimps.com" title="Cyberchimps - Responsive Wordpress Themes" target="_blank">
              <div class="icon32" id="icon-tools"> <br /> </div>
            </a>
            <h2><?php _e( 'Theme Options', 'cyberchimps' ); ?></h2>
            <a href="http://cyberchimps.com" title="Cyberchimps - Responsive Wordpress Themes" target="_blank">
              <h3 class="cc-tag-line"><?php _e( 'Powered by CyberChimps', 'cyberchimps' ); ?></h3>
            </a>
            </div><!-- cc-title -->
				</div><!-- span4 -->
				<div class="span8">
					<ul class="cc-header-links">
          	<li><a href="<?php echo apply_filters( 'cyberchimps_support_forum', 'http://x.co/quicksetup' ); ?>" target="_blank"><?php _e( 'Support', 'cyberchimps' ); ?></a></li>
					</ul>
				</div><!-- span8 -->
			</div><!-- row-fluid -->
			<!-- end header -->
...
function cyberchimps_fields_callback( $value ) {
	...
	switch ( $value['type'] ) {
		...
		case 'general_settings':
			$output .= '<input id="' . esc_attr( $value['id'] ) . '" class="of-input ' . esc_attr( $value['class'] ) . '" name="' . $value['id']  . '" type="text" value="' . get_option($value['id']) . '" />';
			break;
