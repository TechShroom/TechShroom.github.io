...
function cyberchimps_customize( $wp_customize ) {
	...
	$wp_customize->add_section( 'cyberchimps_logo_section', array(
		'title'          => 'Logo',
		'priority'       => 1,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'cyberchimps_options[custom_logo_uploader]', array(
    'label'   => __( 'Logo', 'cyberchimps' ),
    'section' => 'cyberchimps_logo_section',
