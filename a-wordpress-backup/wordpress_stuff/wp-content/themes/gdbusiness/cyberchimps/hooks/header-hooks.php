...
// Display description if it is checked on and the supplied text is not empty
function cyberchimps_header_description() {

	// Get description options.
	$desc_toggle	= cyberchimps_get_option('description_toggle');
...
function cyberchimps_header_logo() {
	...
	if ( cyberchimps_get_option('custom_logo_uploader') != '') {
	...
	<?php
		cyberchimps_header_description();
	}
	else {
...
function cyberchimps_header_site_title() { ?>	
    ...
    <?php cyberchimps_header_description(); ?>
	</hgroup>
<?php }
...
function cyberchimps_header_social_icons() {
	...
	if( $folder == 'default' || $folder == 'round' || $folder == 'legacy' ) {
		$social_image = get_template_directory_uri() . '/cyberchimps/lib/images/social/' . $folder;
	}
	else {
		$social_image = get_template_directory_uri() . '/images/social/' . $folder;
	}
...
// return social icons
function cyberchimps_get_header_social_icons() {
	
	$folder = ( cyberchimps_get_option( 'theme_backgrounds', 'default' ) ) ? cyberchimps_get_option( 'theme_backgrounds', 'default' ) : 'default';
	
	// Set path of social image folder.
	if( $folder == 'default' || $folder == 'legacy' || $folder == 'round' ) {
		$social_image = get_template_directory_uri() . '/cyberchimps/lib/images/social/' . $folder;
	}
	else {
		$social_image = get_template_directory_uri() . '/images/social/' . $folder;
